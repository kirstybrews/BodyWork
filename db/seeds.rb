...
record1 = Record.create(user_id: kirsty.id, exercise_id: bw_pull_up, weight: 0, sets: 3, total_reps: 15)
record2 = Record.create(user_id: romina.id, exercise_id: bw_squat, weight: 0, sets: 3, total_reps: 45)
record3 = Record.create(user_id: kirsty.id, exercise_id: crunch, weight: 0, sets: 3, total_reps: 45)
